...
Generation capability and export. No new production dependency, model/browser runtime, hosted account, telemetry, or database tables. No PDF reader, browser-based web research, automatic academic citation formatting, cross-workspace knowledge base, or deep-research system in v1.
